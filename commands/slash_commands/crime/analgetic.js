...
module.exports = (interaction) =>{
    ...
    const Embed = new EmbedBuilder()
        .setTitle('Отчет о заказе анальгетиков')
    ...
    collector.on('collect', async i => {
        ...
        await i.update({embeds:[Embed],content:`***<@${interaction.member.id}> отправил отчет о заказе поставки Анальгетика***`, components: [row]})
