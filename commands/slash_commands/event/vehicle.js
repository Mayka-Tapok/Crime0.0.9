...
module.exports = (interaction, adminrole) => {
    ...
    collector.on('collect', async i => {
        var adminrol = i.member.guild.roles.cache.get('1082620880619831327')
                if (!i.member.guild.roles.cache.has("1082620880619831327")) {
